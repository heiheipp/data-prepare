DROP TABLE IF EXISTS `ads_txn_tif_bas_400c`;
CREATE TABLE `ads_txn_tif_bas_400c`
(
    ...
    col301                               varchar(20)                                      DEFAULT '',
    col302                               varchar(20)                                      DEFAULT '',
    col303                               varchar(20)                                      DEFAULT '',
    col304                               varchar(20)                                      DEFAULT '',
    col305                               varchar(20)                                      DEFAULT '',
    col306                               varchar(20)                                      DEFAULT '',
    col307                               varchar(20)                                      DEFAULT '',
    col308                               varchar(20)                                      DEFAULT '',
    col309                               varchar(20)                                      DEFAULT '',
    col310                               bigint(20)                                       DEFAULT '31415',
    col311                               bigint(20)                                       DEFAULT '31415',
    col312                               bigint(20)                                       DEFAULT '31415',
    col313                               bigint(20)                                       DEFAULT '31415',
    col314                               bigint(20)                                       DEFAULT '31415',
    col315                               bigint(20)                                       DEFAULT '31415',
    col316                               bigint(20)                                       DEFAULT '31415',
    col317                               bigint(20)                                       DEFAULT '31415',
    col318                               bigint(20)                                       DEFAULT '31415',
    col319                               bigint(20)                                       DEFAULT '31415',
    col320                               bigint(20)                                       DEFAULT '112',
    col321                               bigint(20)                                       DEFAULT '112',
    col322                               bigint(20)                                       DEFAULT '112',
    col323                               bigint(20)                                       DEFAULT '112',
    col324                               bigint(20)                                       DEFAULT '112',
    col325                               bigint(20)                                       DEFAULT '112',
    col326                               bigint(20)                                       DEFAULT '112',
    col327                               bigint(20)                                       DEFAULT '112',
    col328                               bigint(20)                                       DEFAULT '112',
    col329                               bigint(20)                                       DEFAULT '112',
    col330                               decimal(10, 2)                                   DEFAULT 20.02,
    col331                               decimal(10, 2)                                   DEFAULT 20.02,
    col332                               decimal(10, 2)                                   DEFAULT 20.02,
    col333                               decimal(10, 2)                                   DEFAULT 20.02,
    col334                               decimal(10, 2)                                   DEFAULT 20.02,
    col335                               decimal(10, 2)                                   DEFAULT 20.02,
    col336                               decimal(10, 2)                                   DEFAULT 20.02,
    col337                               decimal(10, 2)                                   DEFAULT 20.02,
    col338                               decimal(10, 2)                                   DEFAULT 20.02,
    col339                               decimal(10, 2)                                   DEFAULT 20.02,
    col340                               text                                             DEFAULT NULL,
    col341                               text                                             DEFAULT NULL,
    col342                               text                                             DEFAULT NULL,
    col343                               text                                             DEFAULT NULL,
    col344                               text                                             DEFAULT NULL,
    col345                               text                                             DEFAULT NULL,
    col346                               text                                             DEFAULT NULL,
    col347                               text                                             DEFAULT NULL,
    col348                               text                                             DEFAULT NULL,
    col349                               text                                             DEFAULT NULL,
    col350                               varchar(30)                                      DEFAULT '西安支行',
    col351                               varchar(30)                                      DEFAULT '西安支行',
    col352                               varchar(30)                                      DEFAULT '西安支行',
    col353                               varchar(30)                                      DEFAULT '西安支行',
    col354                               varchar(30)                                      DEFAULT '西安支行',
    col355                               varchar(30)                                      DEFAULT '西安支行',
    col356                               varchar(30)                                      DEFAULT '西安支行',
    col357                               varchar(30)                                      DEFAULT '西安支行',
    col358                               varchar(30)                                      DEFAULT '西安支行',
    col359                               varchar(30)                                      DEFAULT '西安支行',
    col360                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col361                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col362                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col363                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col364                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col365                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col366                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col367                               varchar(14)                                      DEFAULT '内蒙古赤峰市',
    col368                               tinyint(2)                                       DEFAULT '11',
    col369                               tinyint(2)                                       DEFAULT '11',
    col370                               tinyint(2)                                       DEFAULT '11',
    col371                               tinyint(2)                                       DEFAULT '11',
    col372                               tinyint(2)                                       DEFAULT '11',
    col373                               tinyint(2)                                       DEFAULT '11',
    col374                               tinyint(2)                                       DEFAULT '11',
    col375                               tinyint(2)                                       DEFAULT '11',
    col376                               tinyint(2)                                       DEFAULT '11',
    col377                               tinyint(2)                                       DEFAULT '11',
    col378                               tinyint(2)                                       DEFAULT '11',
    col379                               tinyint(2)                                       DEFAULT '11',
    col380                               char(1)                                          DEFAULT 'M',
    col381                               char(1)                                          DEFAULT 'M',
    col382                               char(1)                                          DEFAULT 'M',
    col383                               char(1)                                          DEFAULT 'M',
    col384                               char(1)                                          DEFAULT 'M',
    col385                               char(1)                                          DEFAULT 'M',
    col386                               char(1)                                          DEFAULT 'M',
    col387                               char(1)                                          DEFAULT 'M',
    col388                               char(1)                                          DEFAULT 'M',
    col389                               char(1)                                          DEFAULT 'M',
    col390                               varchar(15)                                      DEFAULT '贷款用户',
    col391                               varchar(15)                                      DEFAULT '贷款用户',
    col392                               varchar(15)                                      DEFAULT '贷款用户',
    col393                               varchar(15)                                      DEFAULT '贷款用户',
    col394                               varchar(15)                                      DEFAULT '贷款用户',
    col395                               varchar(15)                                      DEFAULT '贷款用户',
    col396                               varchar(15)                                      DEFAULT '贷款用户',
    col397                               varchar(15)                                      DEFAULT '贷款用户',
    col398                               varchar(15)                                      DEFAULT '贷款用户',
    col399                               varchar(15)                                      DEFAULT '贷款用户',
    col400                               decimal(10, 5)                                   DEFAULT 200.235,
    PRIMARY KEY (UNN_TRNO, TXN_DT) CLUSTERED,
    UNIQUE KEY UN_ADS_TXN_TIF_BAS_1 (TXN_DT, BOCGP_INST_NO, TXN_ACCNO, ORI_RCRD_NO, RCRD_NO)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='基础交易信息表_400c';
...
--     ACPE_SN varchar(2) DEFAULT NULL COMMENT '真实收款人障号',
--     ACPE_ACC_BLNG_ORGNM varchar(210) DEFAULT NULL COMMENT '真实收款人账户所属机构名称',
--     ACPE_ACC_BLNG_ORGNO varchar(14) DEFAULT NULL COMMENT '真实收款人账户所用机构号',