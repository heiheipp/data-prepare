...
(
    ...
    PRIMARY KEY (`column_9`,`column_5`,`column_1`),
    KEY `idx_table1_1` (`column_144`),
    KEY `idx_table1_2` (`column_1`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='交易基础信息表';

create index idx_table1_1 on test_table_1 (column_144);
create index idx_table1_2 on test_table_1 (column_1);
