 ...
 * @author zhangxi
 * @version 1.0
 * @className CsvConfigNew
 * @desc TODO
 * @date 2022/3/13 18:46
 */
public class CsvConfigNew <T extends CsvConfigNew<T>> implements Serializable {
    ...
    /**
     * 设置注释无效<br>
     * 当写出CSV时，{@link CsvWriterNew#writeComment(String)}将抛出异常<br>
     * 当读取CSV时，注释行按照正常行读取
     *
     * @return this
     * @since 5.7.14
