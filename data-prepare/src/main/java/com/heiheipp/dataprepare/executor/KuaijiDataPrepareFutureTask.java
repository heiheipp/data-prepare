 ...
 * @author zhangxi
 * @version 1.0
 * @className KuaijiDataPrepareFutureTask
 * @desc TODO
 * @date 2022/9/11 16:58
 */
@Slf4j
public class KuaijiDataPrepareFutureTask extends AbstractFutureTask<String> {
     ...
     * @param configModel
     */
    public KuaijiDataPrepareFutureTask(long parentThreadId, int threadCustNums, int threadOrder,
